...
parser = argparse.ArgumentParser(description='submit the MINIAOD step for 2023 SUEP MC')
parser.add_argument(
    '--fileList',
    '-f',
    required=True,
    type=str,
    nargs='?',
    help='List of files to perform the miniAOD step on'
)
parser.add_argument(
    '--nFilesPerJob',
    '-n',
...
jobName = f'SUEP2023_MINIAOD_{todaysDate}'
...
config = f'{os.environ["CMSSW_BASE"]}/src/MCProduction/SUEPProduction/python/SUEP_MINIAOD_2023.py'
