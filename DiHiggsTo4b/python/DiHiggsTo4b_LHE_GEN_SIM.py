...
# with command line options: Configuration/Generator/python/DiHiggsTo4b_fragment.py --fileout file:out.root --mc --eventcontent RAWSIM,LHE --datatier GEN-SIM,LHE --conditions 124X_mcRun3_2022_realistic_v10 --beamspot Realistic25ns13p6TeVEarly2022Collision --step LHE,GEN,SIM --geometry DB:Extended --era Run3 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/Generator/python/DiHiggsTo4b_fragment.py nevts:1'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/hdfs/store/user/aloeliger/DiHiggsTo4b_13p6TeV_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
                                             nEvents = cms.untracked.uint32(options.nEventsPerJob),
